...
class Adafruit_RA8875 : public Adafruit_GFX {
 public:
  ...
  /* Layering functions */
  void    enableTwoLayers(boolean on);
  void    enableTransparentMode(boolean on, uint16_t transColor);
...
#define RA8875_LAYER_MODE             0x20
#define RA8875_TWO_LAYERS             0x80

#define RA8875_LAYER_SELECT           0x41
#define RA8875_L2_SELECT              0x01

#define RA8875_LTPR0                  0x52
#define RA8875_L1_VIS                 0x00
#define RA8875_L2_VIS                 0x01
#define RA8875_TRANS                  0x03

#define RA8875_LTPR1                  0x53

#define RA8875_BGTR_RED               0x67
#define RA8875_BGTR_GREEN             0x68
#define RA8875_BGTR_BLUE              0x69
